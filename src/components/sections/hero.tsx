  ...
  return (
    <section className="relative pt-32 pb-32 overflow-hidden flex flex-col items-center justify-center text-center px-6 min-h-[80vh]">
      ...
      <div className="max-w-5xl mx-auto z-10">
        ...
        >
          <span className="drop-shadow-2xl">REDMI 12 5G</span>
          <span className="text-muted-foreground/30 italic">POCO M6 PRO 5G</span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-sm md:text-lg text-muted-foreground max-w-2xl mx-auto mb-12 font-medium leading-relaxed tracking-tight"
        >
