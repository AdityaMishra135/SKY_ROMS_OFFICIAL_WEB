...
import { listenGlobalTheme } from '@/lib/themeRealtime';
...
function RootContent({ children }: { children: React.ReactNode }) {
  ...
  const icon = localStorage.getItem("favicon");
  if (icon) {
